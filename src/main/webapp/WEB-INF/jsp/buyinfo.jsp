 ...
 <div class="buyinfo">
  <div class="buyDtl">
   <div class="buyDtlLeft">
    <div class="buyimgBig">
     <img src="${contextPath}/customer-pictures/${pro.printUrl}" width="360" height="360" />
     <img src="${contextPath}/customer-pictures/${pro.printUrl}" width="360" height="360" />
     <img src="${contextPath}/customer-pictures/${pro.printUrl}" width="360" height="360" />
     <img src="${contextPath}/customer-pictures/${pro.printUrl}" width="360" height="360" />
     <img src="${contextPath}/customer-pictures/${pro.printUrl}" width="360" height="360" />
   ...
   <div class="buyDtlRight">
    <h3>${pro.name}</h3>
    <h4>${pro.describe}</h4>
    <h5>价格：<span>￥</span><strong id="price_item_1">${pro.price}</strong></h5>
    ...
    <div class="goumai">
     <a href="${contextPath}/addCar/${pro.id}" class="buy-gou">立即购买</a>
     <a href="${contextPath}/addCar/${pro.id}" class="buy-mai">加入购物车</a>
    </div><!--goumai/-->
   </div><!--buyDtlRight/-->
   <div class="clears"></div>
  </div><!--buyDtl/-->
