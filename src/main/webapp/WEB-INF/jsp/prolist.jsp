...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
  ...
  <div class="phoneBox">
   <dl>
    <dt><a href="buyinfo.jsp"><img src="images/phone5.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="images/phone4.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="images/phone3.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="images/phone1.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
